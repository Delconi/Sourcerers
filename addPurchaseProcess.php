...
if(empty($_POST ["pPNo"])){
	...
	}else if(empty($_POST["pManufacturer"])||empty($_POST["pPNo"])||empty($_POST ["pQuantity"])||empty($_POST ["pPNo"])||empty($_POST["pSellPrice"])||typeCheck($_POST['pPrice'],'numeric',255)==FALSE||typeCheck($_POST['pQuantity'],'numeric',255)==FALSE||typeCheck($_POST['pSellPrice'],'numeric',255)==FALSE){
		header($reDirect);
	}else{
